...
################################################################################
## Form generated from reading UI file 'dialog_repair_data.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_step2.setText(QCoreApplication.translate("Dialog", u"Place the .BIN file in the same folder as the recorded .csv file and select the .csv file to repair", None))
        self.btn_browse.setText(QCoreApplication.translate("Dialog", u"Browse", None))
        self.warning_label.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p align=\"center\"><span style=\" color:#d90000;\">The folder must contain a .BIN file</span></p></body></html>", None))
    # retranslateUi
